...
type MovieCardProps = Pick<
  Movie,
  'id' | 'title' | 'posterPath' | 'overview' | 'voteAverage' | 'releaseDate'
> & {
  position: number;
};
          ...
          <div className="group p-6 grid z-10">
            ...
            <div className="h-28">
              <span className="line-clamp-4 py-2 text-sm font-light leading-relaxed">
                {truncate({ input: overview, length: 180, wordCheck: true })}
              </span>
            </div>
            <div className=" grid-cols-2 flex group justify-between">
              ...
              <div className="flex flex-col items-end">
                <div className="h-7" />
                <span className="text-3xl  font-bold  gap-x-2 text-slate-300"># {position}</span>
              </div>
            </div>
          </div>
        </div>
